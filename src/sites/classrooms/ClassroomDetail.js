                    ...
                    <div className={"md:basis-2/6 basis-full mb-3 px-5"}>
                        ...
                        <div className={"shadow-lg bg-gray-50 border p-2 rounded px-5 h-full pt-5"}>
                            {data.teachers !== undefined ?
                                <div>
                                    <div className={"font-bold text-blue-900 mb-3"}>Giáo viên</div>
                                    <div className={"flex flex-wrap"}>
                                        {data.teachers.map((teacher) =>
                                            <Link to={"/teacher/" + teacher.value + "/show"}>
                                                <div className={"flex basis-1/2 items-center mb-3"}>
                                                    <div className={"mr-2"}>
                                ...
                                : null}
                            {data.supporters !== undefined && data.supporters.length > 0 ?
                                <div>
                                    <div className={"font-bold text-blue-900 mb-3"}>Trợ giảng</div>
                                    <div className={"flex flex-wrap"}>
                                        {data.supporters.map((teacher) =>
                                            <Link to={"/teacher/" + teacher.value + "/show"}>
                                                <div className={"flex basis-1/2 items-center mb-3"}>
                                                    <div className={"mr-2"}>
                                                        <img src={teacher.avatar}
                                ...
                                : null}
                            {data.students !== undefined && data.students.length > 0 ?
                                <div>
                                    <div className={"font-bold text-blue-900 mb-3"}>Học sinh</div>
                                    <div className={"flex flex-wrap"}>
                                        {data.students.map((student) =>
                                            <Link to={"/student/" + student.id + "/show"}>
                                                <div className={"flex basis-1/2 items-center mb-3"}>
                                                    <div className={"mr-2"}>
                            ...
                            {data.lessons.map((lesson) =>
                                <div key={lesson.id} className={"lg:basis-1/4 md:basis-1/2 basis-full p-2 mb-3"}>
                                    <div className={"border p-2 pt-4 rounded shadow-lg relative"}>
                                        <div className={"flex rounded justify-center items-center bg-blue-600 text-white absolute px-2 h-[1.5rem] -top-[0.5rem] -left-[0.5rem]"}>
                                            Buổi {lesson.session}
                                        </div>
