                    ...
                    <div className={"flex flex-wrap p-2 h-full"}>
                        ...
                        <div className={"md:basis-1/2 basis-full p-2"}>
                            <div className={"border p-5 bg-gray-50 rounded-2xl h-full"}>
                                ...
                                <div className={"mt-2 text-gray-600"}>
                                    ...
                                    <span className={"ml-2"}>Mã HS: {data.code || ''}</span>
                                </div>
                                <div className={"mt-2 text-gray-600"}>
                                ...
                                <div className={"mt-2 text-gray-600"}>
                                    ...
                                    <span className={"ml-2"}>Giám hộ: {data.parent || ''}</span>
                                </div>
                            </div>
                        </div>
                        <div className={"md:basis-1/3 basis-full p-2"}>
                            {data.grade ?
                                ...
                                :
                                <div className={"border p-5 flex justify-center items-center bg-gray-50 rounded-2xl h-full"}>
